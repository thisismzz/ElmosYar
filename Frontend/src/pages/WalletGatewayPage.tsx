...
export function WalletGatewayPage() {
        ...
        <Card className="max-w-lg w-full rounded-2xl border-0 shadow-lg bg-white">
          <CardContent className="p-6 space-y-3">
            ...
            <div className="flex justify-end">
              <Button onClick={() => navigate("/profile/wallet")} className="rounded-xl">
                بازگشت
              </Button>
            </div>
          </CardContent>
  ...
  const pay = async () => {
    ...
    try {
      ...
      // Card/OTP/captcha are NOT sent to backend in this mock.
      // In real gateway integration, you'd send to payment provider.
