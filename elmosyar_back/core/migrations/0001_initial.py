    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reposts', to='core.post')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='replies', to='core.post')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['created_at'],
                'indexes': [models.Index(fields=['conversation', 'is_read', 'created_at'], name='core_messag_convers_e88c68_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='post',
            index=models.Index(fields=['category', 'created_at'], name='core_post_categor_999696_idx'),
        ),
        migrations.AddIndex(
            model_name='post',
        ...
        migrations.AddIndex(
            model_name='reaction',
            index=models.Index(fields=['post', 'reaction'], name='core_reacti_post_id_a66b58_idx'),
        ),
