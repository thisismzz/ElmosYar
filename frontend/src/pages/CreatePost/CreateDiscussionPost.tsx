...
const ChatPostForm: React.FC<ChatPostFormProps> = ({ 
  ...
  const handleCustomTagInputChange = (e: ChangeEvent<HTMLInputElement>): void => {
    const value = e.target.value;
    const cleanedValue = value.replace(/\s/g, '');
    setCustomTagInput(cleanedValue);
  };
  ...
  const handleCustomTagKeyDown = (e: React.KeyboardEvent<HTMLInputElement>): void => {
    if (e.key === 'Enter') {
      e.preventDefault();
      handleAddCustomTag();
    }
    ...
    <div className={`chat-post-form-container ${isClosing ? 'closing' : ''}`}>
      <div ref={formRef} className={`chat-post-form ${isClosing ? 'slide-out' : 'slide-in'}`} dir="rtl">
        <div className="form-content-wrapper">
            ...
            <div className="form-group">
              ...
              <div className="tags-input-container">
                ...
                <div className="tags-display-section">
                  ...
                  {/* دکمه افزودن هشتگ - فقط یک بار نمایش داده شود */}
                  {!showAvailableTags && (
                  ...
                  <div ref={dropdownRef} className="available-tags-dropdown">
                    ...
                    <div className="custom-tag-input-container">
                      <input
                        ...
                        placeholder="هشتگ دلخواه بنویسید..."
                      ...
                      {filteredAvailableTags.length > 0 ? (
                        <>
                          <div className="available-tags-count">
                            {filteredAvailableTags.length} هشتگ موجود
                          </div>
          ...
          {/* Form Actions - دکمه‌های انتشار پست و انصراف */}
